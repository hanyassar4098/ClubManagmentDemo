...
namespace DAL.Core.Interfaces
{
    public interface IAccountManager
    {
        ...
        Task<(bool Succeeded, string[] Errors)> CreateUserAsync(ApplicationUser user, IEnumerable<string> roles, IEnumerable<string> services, string password);
        ...
        Task<(ApplicationUser User, string[] Roles, string[] Services)?> GetUserAndRolesAsync(string userId);
        Task<ApplicationUser> GetUserByEmailAsync(string email);
        Task<ApplicationUser> GetUserByIdAsync(string userId);
        Task<ApplicationUser> GetUserByUserNameAsync(string userName);
        Task<IList<string>> GetUserRolesAsync(ApplicationUser user);
        Task<List<(ApplicationUser User, string[] Roles, string[]  Services, decimal Totalcost)>> GetUsersAndRolesAsync(int page, int pageSize);
        ...
        Task<(bool Succeeded, string[] Errors)> UpdateUserAsync(ApplicationUser user, IEnumerable<string> roles, IEnumerable<string> services);
