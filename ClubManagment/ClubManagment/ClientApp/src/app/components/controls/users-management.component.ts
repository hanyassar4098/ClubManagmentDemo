...
export class UsersManagementComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('servicesTemplate', { static: true })
  servicesTemplate: TemplateRef<any>;
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      { prop: 'services', name: gT('users.management.Services'), width: 600, cellTemplate: this.servicesTemplate },
      { prop: 'totalCost', name: gT('users.management.TotalCost'), width: 100 }
    ];
