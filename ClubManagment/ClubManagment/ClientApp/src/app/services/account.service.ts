...
export class AccountService {
  ...
  getUser(userId?: string) {
    return forkJoin([
      ...
      this.accountEndpoint.getServicesEndpoint<Service[]>()]);
  ...
  newService(news: Service) {
    return this.accountEndpoint.getNewServiceEndpoint<Service>(news);
  }
  ...
  getServices(page?: number, pageSize?: number) {
    ...
    return this.accountEndpoint.getServicesEndpoint<Service[]>(page, pageSize);
  }
